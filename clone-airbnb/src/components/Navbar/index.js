                        ...
                        <ul class="navbar-nav me-auto mx-auto mb-2 mb-lg-0">
                            <div className='rounded-pill px-2 shadow-sm border border-2'>
                                <form class="d-flex w-100 me-2 m-1" role="search">
                                    ...
                                    <button class=" rounded-circle px-2 border-0 searchButton" type="submit">< i class="bi bi-search m-1 text-light d-flex align-items-center align-items-center"></i></button>
                                </form>
                            </div>
                        </ul>
